...
var drawCloudDefault = function(){
    var TARGET_ELEMENT_ID = '#cloud_spain';  
var data = d3.entries(SPAIN_14);
console.log(data);
    var cloudDimensions = document.querySelector ('#cloud_spain').getBoundingClientRect();
...
var drawCloudSPAIN = function(selectedDateStart){
    d3.select("#cloud_spain").selectAll("*").remove();
  var selectedCloud = "SPAIN_" + selectedDateStart ;
...
var drawCloudd = function(selectedPlace,selectedDateStart){
    d3.select("#cloud_spain").selectAll("*").remove();

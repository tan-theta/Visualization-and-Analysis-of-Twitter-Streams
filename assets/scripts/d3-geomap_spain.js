...
//            var counter = 0;
            ...
            if (counterr %2==0){
                ...
                d3.selectAll(".unit").style("opacity", "1").attr("filter", "url(#no-filter)").style("stroke-width", "0.5");
//                d3.selectAll("g.units.zoom").attr("filter", "url(#map-filter)");
                
            }
            else{
               d3.selectAll(".unit").style("opacity", "0.4").style("stroke-width", "0.5");
